...
import Menu from './homeopen-banner-img.jpg'
import { Typography } from "@mui/material";
import Woodie from './homeopen-banner-img.jpg';
import './Nav.css'
  ...
  Woodie
        ...
        <div className={`nav-elements  ${showNavbar && 'active'}`}>
          <ul style={{alignItems:'center'}}>
            ...
            <li>
              <Button onClick={()=> {}} variant="contained" className='mapbtn' style={{background:'#252525',borderRadius:20,paddingRight:32,paddingLeft:32}} >
                Map
              </Button>
            </li>
          </ul>
